...
import cn.zhuatech.billing.domain.DomainCatalog;
...
public class BillingService {
    ...
    public BillingService(BusinessRecordRepository records,AuditLogRepository audits,SystemSettingRepository settings,DomainCatalog catalog){
